...
get_ipython().run_line_magic('mesh', "= TetraMesh.from_vtk('benchmarks/004-eliptic-membrane/eliptic-membrane.vtu', show_edges = True)")

get_ipython().run_line_magic('sigmayy_min', '= -3.4e7')
get_ipython().run_line_magic('sigmayy_max', '= 9.3e7')
